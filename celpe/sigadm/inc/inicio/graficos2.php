...
?>
    ...
    <div class="row text-center jumper-20">
        <a href="/adm/admin/relatorios/graficos/dashboard/<?=$campanha->id?>" class="icon-btn" target="_blank">
...
<?	
    ...
    <div class="row text-center jumper-20">
        <a href="/adm/admin/relatorios/graficos/dashboard-geral" class="icon-btn" target="_blank">
            <i class="fa fa-print"></i>
            <div> <?=$translate->translate('imprimir')?> </div>
        </a>
    </div>
