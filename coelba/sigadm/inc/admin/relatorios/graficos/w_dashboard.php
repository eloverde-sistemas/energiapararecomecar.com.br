...
<?	
		...
		<hr>
		<p style="font-size:16px; font-weight:bold">Relação das Inscrições e Cupons</p>
		...
		<?	if($qtdeTotalES){ ?>
				<hr>
				<p style="font-size:16px; font-weight:bold">Elementos Sorteáveis</p>
				<div id="elementosSorteaveis"></div>

				<hr>
				<p style="font-size:16px; font-weight:bold">Alcance por Faixa Etária</p>
	...
	<?	if($campanha->id_tipo_campanha==3  && $campanha->id > 0){ ?>
